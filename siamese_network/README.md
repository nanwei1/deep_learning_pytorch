...
Before Training:
<p align="center"> <img src=".//results_cnn/Epoch_0.png" width="600"/> </p>
Epoch 10:
<p align="center"> <img src=".//results_cnn/Epoch_10.png" width="600"/> </p>
Epoch 20:
<p align="center"> <img src=".//results_cnn/Epoch_20.png" width="600"/> </p>
Epoch 50:
<p align="center"> <img src=".//results_cnn/Epoch_50.png" width="600"/> </p>
Applying a logistic regression model on the embeddings:
<p align="center"> <img src=".//results_cnn/Simple Classifier.png" width="600"/> </p>


## Embeddings Generated by the siamese network:
Before Training:
<p align="center"> <img src=".//results_siamese/Epoch_0.png" width="600"/> </p>
Epoch 10:
<p align="center"> <img src=".//results_siamese/Epoch_10.png" width="600"/> </p>
Epoch 20:
<p align="center"> <img src=".//results_siamese/Epoch_20.png" width="600"/> </p>
Epoch 50:
<p align="center"> <img src=".//results_siamese/Epoch_50.png" width="600"/> </p>
Applying a logistic regression model on the embeddings:
<p align="center"> <img src=".//results_siamese/Simple Classifier.png" width="600"/> </p>
